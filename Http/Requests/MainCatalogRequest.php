    ...
    class MainCatalogRequest extends FormRequest
    {
        ...
        public function rules(): array
        {
            ...
            foreach ($this->LANGUAGES as $language) {
                ...
                if ($this->segment(4) == 'store') {
                    ...
                    $array['thumbnail_' . $language->code] = 'required|mimes:png,jpeg|max:3000';
                }

                if ($this->segment(5) == 'update') {
                    $array['filename_' . $language->code]  = 'mimes:pdf|max:200000';
                    $array['thumbnail_' . $language->code] = 'mimes:png,jpeg|max:3000';
                }
            }
        ...
        public function messages()
        {
            ...
            foreach ($this->LANGUAGES as $language) {
                ...
                $messages['thumbnail_' . $language->code . '.mimes']    = 'Thumbnail за езикова версия ' . $language->code . ' трябва да е .png или .jpeg файл';
