...
@section('content')
    ...
    <form class="my-form" action="{{ route('admin.catalogs.main.update', ['id' => $mainCatalog->id]) }}" method="POST" data-form-type="store" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    <div style="display: flex;align-items: center;">
                                        <div style="display: flex;align-items: center;flex-direction: column;">
                                            <h3 style="margin: 0;"><i class="fas fa-file-pdf"></i></h3><br>
                                            <div class="m-l-5"><a href="{{ $currentTranslation->fullPdfFilePathUrl() }}" target="_blank">{{ __('catalogs::admin.common.view_catalog') }}</a></div>
                                        </div>
                                        <div class="m-l-5" style="display: flex;align-items: center;flex-direction: column;">
                                            <h3 style="margin: 0;"><i class="fas fa-download"></i></h3><br>
                                            <div class="m-l-5"><a href="{{ $currentTranslation->fullPdfFilePathUrl() }}" download>{{ __('catalogs::admin.common.download_catalog') }}</a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    <div>
                                        <img class="img-responsive" width="350" src="{{ $currentTranslation->fullImageFilePathUrl() }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form form-horizontal">
                    <div class="form-body">
                        @include('admin.partials.on_edit.active_checkbox', ['model' => $mainCatalog])
                    </div>
